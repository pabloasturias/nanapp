...
interface GenderData {
    ...
    head: GrowthData[]; // cm (Head Circumference)
}
...
export const WHO_DATA: { boys: GenderData; girls: GenderData } = {
    boys: {
        ...
        head: [
            [0, 31.9, 33.2, 34.5, 35.8, 37.0],
            [3, 37.7, 39.0, 40.5, 42.0, 43.2],
            [6, 40.5, 41.9, 43.3, 44.8, 46.0],
            [9, 42.2, 43.6, 45.0, 46.5, 47.7],
            [12, 43.5, 44.9, 46.1, 47.6, 48.8],
            [15, 44.5, 45.8, 47.1, 48.4, 49.6],
            [18, 45.2, 46.5, 47.8, 49.0, 50.2],
            [24, 46.3, 47.5, 48.9, 50.2, 51.4]
        ]
    },
    girls: {
        weight: [
        ...
        head: [
            ...
            [3, 37.0, 38.3, 39.5, 40.7, 41.9],
            [6, 39.4, 40.8, 42.2, 43.6, 44.8],
            [9, 41.2, 42.6, 44.0, 45.4, 46.6],
            [12, 42.2, 43.6, 45.0, 46.3, 47.6],
            [15, 43.1, 44.4, 45.8, 47.1, 48.3],
            [18, 43.8, 45.1, 46.4, 47.7, 48.9],
            [24, 44.9, 46.1, 47.5, 48.8, 50.0]
        ]
    }
};
