...
import { Heart, Music, Sparkles, BookOpen, ArrowLeft, Star, ShieldCheck, Users } from 'lucide-react';
        ...
        <div className="space-y-8">
            ...
            <div className="px-4 space-y-10">
                ...
                <div className="flex gap-5">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-orange-50 mb-3">{t('story_promise_title')}</h3>
                ...
                <div className="bg-slate-800/30 rounded-3xl p-6 border border-white/5 relative overflow-hidden">
                    <div className="relative z-10">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="text-lg font-bold text-orange-50">{t('story_community_title')}</h3>
                        </div>
            ...
            <div className="text-center pt-8 pb-4 space-y-4">
                ...
                <div className="flex justify-center">
                    <div className="flex items-center gap-2 px-6 py-3 rounded-full bg-indigo-950/30 border border-indigo-500/10">
                        <p className="text-[10px] text-indigo-200 uppercase tracking-widest font-bold leading-relaxed max-w-[200px]">{t('inspired_by')}</p>
